...
impl CapitulationStrategy {
    ...
    pub fn get_trade_params(
        ...
        match phase {
            ...
            CapitulationPhase::Trade17 => Some((dec!(74405.0), dec!(75130.0), dec!(72405.0))),
            CapitulationPhase::Trade18 => Some((dec!(72405.0), dec!(73130.0), dec!(70405.0))),
            CapitulationPhase::Trade19 => Some((dec!(70405.0), dec!(71130.0), dec!(68405.0))),
            CapitulationPhase::Trade20 => Some((dec!(68405.0), dec!(69130.0), dec!(66405.0))),
            CapitulationPhase::Trade21 => Some((dec!(66405.0), dec!(67130.0), dec!(64405.0))),
            CapitulationPhase::Trade22 => Some((dec!(64405.0), dec!(65130.0), dec!(62405.0))),
            CapitulationPhase::Trade23 => Some((dec!(62405.0), dec!(63130.0), dec!(60405.0))),
            CapitulationPhase::Trade24 => Some((dec!(60405.0), dec!(61130.0), dec!(58405.0))),
            CapitulationPhase::Trade25 => Some((dec!(58405.0), dec!(59130.0), dec!(56405.0))),
            CapitulationPhase::Trade26 => Some((dec!(56405.0), dec!(57130.0), dec!(54405.0))),
            CapitulationPhase::Trade27 => Some((dec!(54405.0), dec!(55130.0), dec!(52405.0))),
            CapitulationPhase::Trade28 => Some((dec!(52405.0), dec!(53130.0), dec!(50405.0))),
            CapitulationPhase::Trade29 => Some((dec!(50405.0), dec!(51130.0), dec!(48405.0))),
            CapitulationPhase::Trade30 => Some((dec!(48405.0), dec!(49130.0), dec!(46405.0))),
            CapitulationPhase::Trade31 => Some((dec!(46405.0), dec!(47130.0), dec!(44405.0))),
            CapitulationPhase::Trade32 => Some((dec!(44405.0), dec!(45130.0), dec!(42405.0))),
            CapitulationPhase::Trade33 => Some((dec!(42405.0), dec!(43130.0), dec!(40405.0))),
            CapitulationPhase::Trade34 => Some((dec!(40405.0), dec!(41130.0), dec!(38405.0))),
            CapitulationPhase::Trade35 => Some((dec!(38405.0), dec!(39130.0), dec!(36405.0))),
