...
impl CapitulationStrategy {
    ...
    pub fn get_trade_params(
        ...
        match phase {
            CapitulationPhase::Trade1 => Some((dec!(108405.0), dec!(108755.0), dec!(107535.0))),
            CapitulationPhase::Trade2 => Some((dec!(107405.0), dec!(107755.0), dec!(104535.0))),
            CapitulationPhase::Trade3 => Some((dec!(104405.0), dec!(104755.0), dec!(100535.0))),
            CapitulationPhase::Trade4 => Some((dec!(100405.0), dec!(100755.0), dec!(98535.0))),
            CapitulationPhase::Trade5 => Some((dec!(98405.0), dec!(98755.0), dec!(96535.0))),
            CapitulationPhase::Trade6 => Some((dec!(96405.0), dec!(96755.0), dec!(92535.0))),
            CapitulationPhase::Trade7 => Some((dec!(94405.0), dec!(94755.0), dec!(92535.0))),
            CapitulationPhase::Trade8 => Some((dec!(92405.0), dec!(92755.0), dec!(90535.0))),
            CapitulationPhase::Trade9 => Some((dec!(90405.0), dec!(90755.0), dec!(88435.0))),
            CapitulationPhase::Trade10 => Some((dec!(88405.0), dec!(88755.0), dec!(86405.0))),
            CapitulationPhase::Trade11 => Some((dec!(86405.0), dec!(86755.0), dec!(84405.0))),
            CapitulationPhase::Trade12 => Some((dec!(84405.0), dec!(84755.0), dec!(82405.0))),
            CapitulationPhase::Trade13 => Some((dec!(82405.0), dec!(82755.0), dec!(80405.0))),
            CapitulationPhase::Trade14 => Some((dec!(80405.0), dec!(80755.0), dec!(78405.0))),
            CapitulationPhase::Trade15 => Some((dec!(78405.0), dec!(78755.0), dec!(76405.0))),
            CapitulationPhase::Trade16 => Some((dec!(76405.0), dec!(76755.0), dec!(74405.0))),
            CapitulationPhase::Trade17 => Some((dec!(74405.0), dec!(74755.0), dec!(72405.0))),
            CapitulationPhase::Trade18 => Some((dec!(72405.0), dec!(72755.0), dec!(70405.0))),
            CapitulationPhase::Trade19 => Some((dec!(70405.0), dec!(70755.0), dec!(68405.0))),
            CapitulationPhase::Trade20 => Some((dec!(68405.0), dec!(68755.0), dec!(66405.0))),
            CapitulationPhase::Trade21 => Some((dec!(66405.0), dec!(66755.0), dec!(64405.0))),
            CapitulationPhase::Trade22 => Some((dec!(64405.0), dec!(64755.0), dec!(62405.0))),
            CapitulationPhase::Trade23 => Some((dec!(62405.0), dec!(62755.0), dec!(60405.0))),
            CapitulationPhase::Trade24 => Some((dec!(60405.0), dec!(60755.0), dec!(58405.0))),
            CapitulationPhase::Trade25 => Some((dec!(58405.0), dec!(58755.0), dec!(56405.0))),
            CapitulationPhase::Trade26 => Some((dec!(56405.0), dec!(56755.0), dec!(54405.0))),
            CapitulationPhase::Trade27 => Some((dec!(54405.0), dec!(54755.0), dec!(52405.0))),
            CapitulationPhase::Trade28 => Some((dec!(52405.0), dec!(52755.0), dec!(50405.0))),
            CapitulationPhase::Trade29 => Some((dec!(50405.0), dec!(50755.0), dec!(48405.0))),
            CapitulationPhase::Trade30 => Some((dec!(48405.0), dec!(48755.0), dec!(46405.0))),
            CapitulationPhase::Trade31 => Some((dec!(46405.0), dec!(46755.0), dec!(44405.0))),
            CapitulationPhase::Trade32 => Some((dec!(44405.0), dec!(44755.0), dec!(42405.0))),
            CapitulationPhase::Trade33 => Some((dec!(42405.0), dec!(42755.0), dec!(40405.0))),
            CapitulationPhase::Trade34 => Some((dec!(40405.0), dec!(40755.0), dec!(38405.0))),
            CapitulationPhase::Trade35 => Some((dec!(38405.0), dec!(38755.0), dec!(36405.0))),
            ...
            Some(pos) => {
                ...
                if price >= actual_sl {
                    if price >= actual_sl && state.partial_profit_targets.len() == 4 {
                        ...
                        state.cooldown_until = Some(Utc::now() + chrono::Duration::minutes(120));
