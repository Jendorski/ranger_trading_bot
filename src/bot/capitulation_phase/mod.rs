...
impl CapitulationStrategy {
    ...
    pub fn get_trade_params(
        ...
        match phase {
            CapitulationPhase::Trade1 => Some((dec!(92435.0), dec!(92830.0), dec!(91535.0))),
            CapitulationPhase::Trade2 => Some((dec!(91435.0), dec!(91830.0), dec!(90535.0))),
            CapitulationPhase::Trade3 => Some((dec!(90435.0), dec!(90830.0), dec!(89535.0))),
            CapitulationPhase::Trade4 => Some((dec!(89435.0), dec!(90030.0), dec!(88535.0))),
            CapitulationPhase::Trade5 => Some((dec!(88435.0), dec!(89030.0), dec!(87535.0))),
            CapitulationPhase::Trade6 => Some((dec!(87635.0), dec!(88030.0), dec!(86535.0))),
            CapitulationPhase::Trade7 => Some((dec!(86435.0), dec!(87030.0), dec!(85535.0))),
            CapitulationPhase::Trade8 => Some((dec!(85435.0), dec!(86030.0), dec!(84535.0))),
            CapitulationPhase::Trade9 => Some((dec!(84535.0), dec!(85030.0), dec!(83535.0))),
            CapitulationPhase::Trade10 => Some((dec!(83435.0), dec!(84030.0), dec!(82535.0))),
            CapitulationPhase::Trade11 => Some((dec!(82435.0), dec!(83030.0), dec!(81535.0))),
            CapitulationPhase::Trade12 => Some((dec!(81535.0), dec!(81930.0), dec!(80535.0))),
            CapitulationPhase::Trade13 => Some((dec!(80435.0), dec!(81030.0), dec!(79535.0))),
            CapitulationPhase::Trade14 => Some((dec!(79435.0), dec!(79830.0), dec!(78535.0))),
            CapitulationPhase::Trade15 => Some((dec!(78435.0), dec!(79035.0), dec!(77535.0))),
